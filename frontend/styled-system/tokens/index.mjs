const tokens = {
  ...
  "colors.borderMain": {
    "value": "var(--colors-border-main)",
    "variable": "var(--colors-border-main)"
  },
  "colors.bgButtonSecondary": {
    "value": "var(--colors-bg-button-secondary)",
    "variable": "var(--colors-bg-button-secondary)"
  },
  "colors.bgButtonSecondaryHover": {
    "value": "var(--colors-bg-button-secondary-hover)",
    "variable": "var(--colors-bg-button-secondary-hover)"
  },
  "colors.textButtonSecondary": {
    "value": "var(--colors-text-button-secondary)",
    "variable": "var(--colors-text-button-secondary)"
  },
  "spacing.-1": {
